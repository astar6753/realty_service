package com.astar.realty.data.User;
...
public class UserModify {
    ...
    @Data
    @ApiModel(value="UserModify.Request : 서비스 회원정보 수정 요청", description="서비스 회원정보 수정 요청")
    public static class Request {
        ...
        @ApiModelProperty(value="서비스 회원 번호", example = "1")
        @NotNull(message = "서비스 회원 번호를 입력해 주세요.")
        private Integer ui_seq;
    }

    @Getter @Builder
    @ApiModel(value="UserModify.Response : 서비스 회원정보 수정 요청", description="서비스 회원정보 수정 응답")
    public static class Response {

        @ApiModelProperty(value="HttpStatus", example = "OK")
        private HttpStatus status;
        
        @ApiModelProperty(value="응답 메세지", example = "서비스 회원 정보가 수정되었습니다.")
