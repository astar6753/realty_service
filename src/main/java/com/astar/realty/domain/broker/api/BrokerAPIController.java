...
public class BrokerAPIController {
    @Autowired BrokerService service;
        ...
        // (value="BrokerCreate.Request : 공인중개사 회원정보 등록 요청", name="request", dataType="object")
        // (value="BrokerCreate.Request : 공인중개사 회원정보 등록 요청", name="request", dataTypeClass = BrokerCreate.Request.class)
        // @ApiImplicitParam(value="BrokerCreate.Request : 공인중개사 회원정보 등록 요청", name="request", dataType="object")
        // @ApiImplicitParam(value="BrokerCreate.Request : 공인중개사 회원정보 등록 요청", name="request", paramType="body")
    @ApiOperation(value="공인중개사 회원 등록", notes="")
    @ApiImplicitParam(value="BrokerCreate.Request : 공인중개사 회원정보 등록 요청", name="request", dataType = "object",paramType="body")
    @ApiResponses({
    ...
    public ResponseEntity<BrokerCreate.Response> createBroker(
        @RequestBody @Valid BrokerCreate.Request request
        ) {
