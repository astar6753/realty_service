...
import com.astar.realty.domain.realty.data.RealtyTotalInfoVO;
...
public class RealtyAPIController {
    ...
    // )
    // @ApiImplicitParams({
    //     @ApiImplicitParam(name = "request", dataType = "Object"),
    //     @ApiImplicitParam(name = "page", dataType = "Integer", required = false)
    // })
    @PostMapping("/post/list")
    public ResponseEntity<Response> postPostList(
        @RequestBody RealtySearchRequestVO request, 
        @RequestParam @Nullable Integer page
        ){
            Response response = Response.builder()
                                        .status(HttpStatus.OK)
