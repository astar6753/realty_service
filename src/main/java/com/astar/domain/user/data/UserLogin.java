...
public class UserLogin {
    ...
    @Data
    @ApiModel(value="UserLogin.Request : 서비스 회원 로그인 요청", description="서비스 회원 로그인 요청")
    ...
    @Getter @Builder
    @ApiModel(value="BrokerLogin.Response : 서비스 회원 로그인 응답", description="서비스 회원 로그인 응답")
    ...
    @Getter
    @ApiModel(value="BrokerLogin.Result : 서비스 회원 로그인 결과", description="서비스 회원 로그인 결과")
